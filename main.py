...
if __name__ == "__main__":
        ...
        if buscar or (query and query != sl.session_state.ultima_query):
                semanticCtx = semantic_search('teste', chunks, query, 3, True)
                ...
                keywordCtx = keyword_search('teste22', chunks, query, 3, True)
                ...
                hybridCtx = hybrid_search(keywordCtx, semanticCtx, sparse_weight = 0.6, top_k = 3, printer = True)
